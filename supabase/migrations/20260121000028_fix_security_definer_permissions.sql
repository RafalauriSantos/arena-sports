-- ==============================================================================
-- CORRIGIR PERMISSÕES DAS FUNÇÕES SECURITY DEFINER
-- ==============================================================================
-- Garante que as funções security definer tenham todas as permissões necessárias
-- e que sejam executadas com os privilégios corretos
-- ==============================================================================

begin;

-- Recriar função fn_is_public_tenant com permissões explícitas
...
-- Recriar função fn_is_active_court_for_tenant com permissões explícitas
...
-- Recriar função fn_can_insert_public_booking com permissões explícitas
...
-- Recriar política usando as funções corrigidas
...
-- Comentários
comment on function public.fn_can_insert_public_booking(uuid, uuid, text, text, text, timestamptz, timestamptz, numeric) is 'Valida se uma reserva pública pode ser inserida - security definer com role postgres bypassa RLS';
