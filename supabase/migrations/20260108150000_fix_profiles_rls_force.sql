-- Fix RLS policies for profiles - Force update (safe to re-run)
--
-- Este script é idempotente - pode ser executado múltiplas vezes sem erro
-- Usa DROP POLICY IF EXISTS e CREATE OR REPLACE para evitar conflitos

begin;

-- =========================
-- 1. CRIAR FUNÇÃO PARA CRIAR PERFIS FALTANTES
-- =========================
...
-- =========================
-- 2. GARANTIR RLS E POLICIES CORRETAS (IDEMPOTENTE)
-- =========================
...
-- =========================
-- 5. FUNÇÃO PARA CRIAR PERFIL NO SIGNUP (tentar criar trigger)
-- =========================
