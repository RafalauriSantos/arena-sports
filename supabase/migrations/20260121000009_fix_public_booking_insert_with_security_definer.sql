-- ==============================================================================
-- CORRIGIR POLÍTICA DE INSERT PÚBLICO USANDO SECURITY DEFINER
-- ==============================================================================
-- Usa funções security definer que bypassam RLS para verificar tenant e court
-- ==============================================================================

begin;

-- Função para verificar se tenant é público (bypassa RLS)
...
-- Função para verificar se court está ativo e pertence ao tenant (bypassa RLS)
...
-- Cria nova política usando funções security definer
