...
function MacBookMockup({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={`relative ${className}`}>
      {/* Screen */}
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section id="problem" className="py-32 px-6">
        <div 
          ...
          className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${
            isVisible("problem-content") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          <p className="text-[#00FF00] text-sm font-medium tracking-widest uppercase mb-6">O Problema</p>
          <h2 className="text-3xl md:text-5xl font-black mb-8 leading-tight">
            Você ainda gerencia sua arena pelo WhatsApp?
          </h2>
          <div className="grid md:grid-cols-3 gap-6 text-left mt-12">
            {[
              { icon: "📱", title: "Mensagens infinitas", desc: "Horas perdidas respondendo \"tem horário?\" pelo WhatsApp" },
              { icon: "📊", title: "Zero controle", desc: "Sem visibilidade de faturamento, ocupação ou tendências" },
              { icon: "💸", title: "Dinheiro na mesa", desc: "Horários vagos que poderiam estar gerando receita" },
            ].map((item, i) => (
      ...
      <section className="py-32 px-6 overflow-hidden">
        ...
        >
          <p className="text-[#00FF00] text-sm font-medium tracking-widest uppercase mb-6">A Solução</p>
          <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight">
            Uma experiência premium.<br />Para você e seus jogadores.
          </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div 
            ...
            className={`flex justify-center mb-20 transition-all duration-1000 delay-200 ${
              isVisible("mockup-desktop") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
            }`}
          >
            <div className="relative">
              ...
              <div className="text-center mt-8">
                ...
                <p className="text-white/40 text-sm">Controle total em tempo real</p>
              </div>
            </div>
          </div>
          ...
          <div 
            ...
            className={`flex justify-center transition-all duration-1000 delay-300 ${
              isVisible("mockup-mobile") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
            }`}
          >
            <div className="relative">
              <div className="absolute -inset-20 bg-[#00FF00]/5 rounded-full blur-[100px]" />
      ...
      <section id="features" className="py-32 px-6">
        ...
        >
          <p className="text-[#00FF00] text-sm font-medium tracking-widest uppercase mb-6">Funcionalidades</p>
        ...
        >
          ...
          <div className="lg:col-span-2 p-8 bg-gradient-to-br from-[#00FF00]/10 to-transparent rounded-3xl border border-[#00FF00]/20 group hover:border-[#00FF00]/40 transition-all">
            ...
            <p className="text-white/50 leading-relaxed">
              Visualize todos os horários em tempo real. Bloqueie, libere e gerencie reservas com um clique. Sem planilhas, sem confusão.
            </p>
          </div>
          ...
          <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 hover:border-white/10 transition-all group">
            ...
            <p className="text-white/40 text-sm">Compartilhe um único link. Jogadores reservam sozinhos.</p>
          </div>
          ...
          <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 hover:border-white/10 transition-all group">
            ...
            <p className="text-white/40 text-sm">Faturamento em tempo real. Gráficos claros. Decisões inteligentes.</p>
          </div>
          ...
          <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 hover:border-white/10 transition-all group">
            ...
            <p className="text-white/40 text-sm">Horários fixos para seus melhores clientes. Fidelização automática.</p>
          </div>
          ...
          <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 hover:border-white/10 transition-all group">
            ...
            <p className="text-white/40 text-sm">Gerencie múltiplas quadras em um único painel unificado.</p>
          </div>
          ...
          <div className="p-6 bg-white/[0.02] rounded-3xl border border-white/5 hover:border-white/10 transition-all group">
            ...
            <p className="text-white/40 text-sm">Receba antecipado. Sem risco de no-show. Fluxo de caixa saudável.</p>
          </div>
        </div>
      </section>
        ...
        >
          {[
            ...
            <div key={i} className="text-center">
              <p className="text-4xl md:text-5xl font-black text-[#00FF00] mb-2">{stat.value}</p>
        ...
        >
          <div className="p-12 bg-white/[0.02] rounded-3xl border border-white/5">
            <p className="text-2xl md:text-3xl font-medium leading-relaxed mb-8">
              "Antes eu perdia 3 horas por dia no WhatsApp. Agora os jogadores reservam sozinhos e eu foco no que importa: 
              <span className="text-[#00FF00]"> fazer minha arena crescer.</span>"
            </p>
            <div className="flex items-center justify-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-white/40 text-sm">Arena Gol de Placa • São Paulo</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-32 px-6">
        ...
        >
          <p className="text-[#00FF00] text-sm font-medium tracking-widest uppercase mb-6">Investimento</p>
          <h2 className="text-3xl md:text-5xl font-black leading-tight">
        ...
        <div 
          ...
          className={`max-w-md mx-auto transition-all duration-1000 delay-200 ${
            isVisible("pricing-card") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
      ...
      <section className="py-32 px-6">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
            Pronto para transformar<br />sua arena?
          </h2>
          <p className="text-white/50 text-lg mb-10 max-w-xl mx-auto">
            Agende uma demonstração gratuita e veja como o Sport.Ai pode aumentar seu faturamento.
          </p>
          <button
            onClick={() => navigate("/admin/login")}
      ...
      <footer className="py-12 px-6 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold">Sport.Ai</span>
          </div>
          <p className="text-white/30 text-sm">
            © 2025 Sport.Ai. Todos os direitos reservados.
          </p>
