				...
				<div className="max-w-5xl mx-auto relative z-10">
					...
					<div className="text-center mb-8">
						...
						<p className="text-gray-400 text-base max-w-2xl mx-auto">
							Os primeiros 20 arenas que se juntarem agora ganham <strong className="text-white">desconto vitalício</strong>. 
							Não é promoção temporária — é seu preço para sempre.
						</p>
					</div>
								...
								<div className="relative z-10">
									...
									<div className="text-center mb-6">
										...
										<p className="text-sm text-gray-400">
											{foundersProgress.cap - foundersProgress.remaining} arenas já garantiram o desconto
										</p>
									</div>
									...
									<div className="grid md:grid-cols-2 gap-4 mb-6">
										...
										<div className="p-4 bg-white/5 rounded-xl border border-white/10">
											<p className="text-xs uppercase text-gray-500 mb-2 font-bold">Preço Normal</p>
											<div className="flex items-baseline gap-1">
												<span className="text-2xl font-black text-gray-400 line-through">R$ 97</span>
												<span className="text-sm text-gray-500">/mês</span>
											</div>
											<p className="text-xs text-gray-600 mt-1">R$ 1.164/ano</p>
										</div>
										...
										<div className="p-4 bg-emerald-500/10 rounded-xl border-2 border-emerald-500/40 relative overflow-hidden">
											...
											<p className="text-xs uppercase text-emerald-400 mb-2 font-bold">Seu Preço Agora</p>
											<div className="flex items-baseline gap-1">
												<span className="text-3xl font-black text-emerald-400">R$ 67,90</span>
												<span className="text-sm text-emerald-300">/mês</span>
											</div>
											<p className="text-xs text-emerald-300 mt-1 font-bold">R$ 814,80/ano</p>
										</div>
									</div>

									{/* Economia Destaque */}
									<div className="text-center p-4 bg-emerald-500/10 border border-emerald-500/30 rounded-xl mb-6">
										<p className="text-xs uppercase text-gray-400 mb-1">Você Economiza</p>
										<p className="text-3xl font-black text-emerald-400">
											R$ 349,20/ano
										</p>
										<p className="text-xs text-gray-500 mt-1">Todos os anos, para sempre</p>
									</div>
									...
									<div className="space-y-3 mb-6">
										<div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
											...
											<div className="text-left">
												<p className="text-sm font-bold text-white">Acesso Prioritário</p>
												<p className="text-xs text-gray-400">Teste novas funcionalidades antes de todo mundo</p>
											</div>
										</div>
										<div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
											<ShieldCheck className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
											<div className="text-left">
												<p className="text-sm font-bold text-white">Suporte Dedicado</p>
												<p className="text-xs text-gray-400">Atendimento prioritário via WhatsApp</p>
											</div>
										</div>
										<div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
											<TrendingUp className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" />
											<div className="text-left">
												<p className="text-sm font-bold text-white">Desconto Permanente</p>
												<p className="text-xs text-gray-400">Nunca aumenta, mesmo quando subirmos o preço</p>
											</div>
										</div>
									</div>
					...
					{foundersProgress && foundersProgress.remaining === 0 && (
						<div className="max-w-2xl mx-auto p-8 bg-white/5 border border-white/10 rounded-2xl text-center">
							...
							<h3 className="text-2xl font-bold text-white mb-2">Vagas Esgotadas</h3>
							<p className="text-gray-400">
								As 20 vagas do programa Founders foram preenchidas. 
								Você ainda pode assinar pelo preço normal de R$ 97/mês.
							</p>
						</div>
					)}
				</div>
					...
					<div className="max-w-2xl mx-auto">
						...
						<div className="relative group rounded-2xl p-[1px] overflow-hidden transform hover:scale-[1.01] transition-all">
							...
							<div className="relative h-full bg-[#0F1115] rounded-2xl p-6 md:p-8 border border-white/10 group-hover:border-transparent transition-colors">
								...
								<h3 className="text-lg font-bold text-white mb-1">Arena System</h3>
								<p className="text-gray-400 text-xs mb-5">
									Tudo que você precisa para gerenciar sua arena.
								</p>
								...
								{foundersProgress && foundersProgress.remaining > 0 && (
									<div className="mb-4 p-3 bg-emerald-500/10 border border-emerald-500/20 rounded-lg">
										...
										<div className="flex items-baseline gap-1 mb-1">
											<span className="text-2xl font-black text-emerald-400">R$ 67,90</span>
											<span className="text-gray-500 text-xs">/mês</span>
										</div>
										<p className="text-[10px] text-gray-400">
											ou R$ 814,80/ano (12x de R$ 67,90) - Desconto permanente!
										</p>
									</div>
								)}
								...
								<ul className="space-y-3 mb-8 text-xs md:text-sm">
									...
									<li className="flex items-center gap-2 text-white">
										<Check className="w-4 h-4 text-emerald-500 shrink-0" />{" "}
										<strong>Link de Reservas Público</strong>
									</li>
									<li className="flex items-center gap-2 text-white">
										<Check className="w-4 h-4 text-emerald-500 shrink-0" />{" "}
								...
								<Button
									...
									{foundersProgress && foundersProgress.remaining > 0
										? `Garantir Desconto Founder (R$ 67,90/mês)`
								...
								{foundersProgress && (
									<div className="mt-3 space-y-2">
										<div className="flex items-center justify-between text-[10px] text-gray-500">
											...
											<span>
												{Math.max(0, foundersProgress.remaining)} de {foundersProgress.cap} vagas restantes
											</span>
										</div>
