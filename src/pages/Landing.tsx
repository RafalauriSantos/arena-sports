          ...
          >
            <div className="relative z-10 mx-auto max-w-6xl">
              <div className="relative scroll-mt-24 rounded-3xl border border-[var(--az-line)] bg-[var(--az-paper)] px-4 py-16 md:py-20 shadow-sm">
                ...
                <Link
                  to="/login?mode=signup"
                  className="btn-shine relative mt-8 inline-flex h-16 w-full items-center justify-center overflow-hidden rounded-lg bg-[var(--az-navy)] text-lg font-semibold text-white shadow-[0_18px_38px_-20px_rgba(2,6,23,0.72)] transition-colors duration-300 hover:bg-[#1e476c] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--az-navy)]/30 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--az-surface)]"
          ...
          <section className="relative overflow-hidden bg-[var(--az-surface)] px-4 py-16 md:py-20">
            ...
            <div className="ScrollReveal">
              <div className="max-w-3xl mx-auto text-center relative z-10">
                ...
                <Link
                  to="/login?mode=signup"
                  className="btn-shine relative inline-flex h-16 items-center gap-3 overflow-hidden rounded-lg bg-[var(--az-navy)] px-14 text-lg font-semibold text-white shadow-sm transition-[background-color,transform] duration-300 hover:scale-[1.01] hover:bg-[#1e476c] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[var(--az-navy)]/20 focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--az-surface)]"
