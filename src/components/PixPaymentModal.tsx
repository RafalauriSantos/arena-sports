...
export function PixPaymentModal({
	...
	const pixCode = `00020126580014BR.GOV.BCB.PIX0136${
		ARENA_SPORTS_CONFIG.pixKey
	}5204000053039865406${amount.toFixed(2)}5802BR5925${ARENA_SPORTS_CONFIG.name
		.toUpperCase()
		.slice(0, 25)}6009SAO PAULO62140510${bookingCode}6304`;
