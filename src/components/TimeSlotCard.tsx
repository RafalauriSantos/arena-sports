	...
	return (
		<button
			...
			className={cn(
				...
				isAvailable &&
					"bg-card border-2 border-primary/30 hover:border-primary hover:glow-primary cursor-pointer",
				isPending &&
					"bg-warning/5 border-2 border-warning/40 cursor-not-allowed",
				isReserved &&
					"bg-card/30 border border-border/50 cursor-not-allowed opacity-60"
			)}>
			{/* Left side - Time */}
