...
async function simulateOnboarding(user: any) {
  ...
  try {
    ...
    console.log('❌ Erro no onboarding:', error.message)
    return null
  }
}
...
async function simulateAsaasCheckout(user: any, tenantData: any) {
  ...
  try {
    ...
    console.log('❌ Erro no checkout Asaas:', error.message)
...
async function simulateWebhook(tenantData: any, subscriptionData: any) {
...
async function verifyFinalState(tenantData: any) {
...
async function runCompleteFlowTest() {
  ...
  try {
    ...
    console.log('💥 ERRO CRÍTICO no fluxo:', error.message)
  }
