...
const CRITICAL_HTML = `<div id="root"><div data-seo-ready class="min-h-screen bg-[#eef4fb] text-slate-950 font-sans"><main class="relative z-10"><h1 class="text-4xl md:text-5xl font-bold tracking-tight text-slate-950 mt-8">Sistema de reservas para arenas esportivas | ArenaSys</h1><p class="text-lg md:text-xl text-slate-600 mt-4 max-w-2xl">Organize quadras, horarios, clientes e pagamentos em um link publico e um painel simples para sua equipe acompanhar a operacao.</p><p class="text-slate-500 mt-4">Agenda online, link publico de reservas, painel de gestao e acesso antecipado para as primeiras arenas que querem implantar com acompanhamento direto.</p><ul class="text-slate-600 mt-4 space-y-2"><li>Link proprio para reservas sem app obrigatorio</li><li>Agenda por quadra, data e horario</li><li>Painel para acompanhar reservas, receita e pendencias</li><li>Pagamento no balcao hoje, Pix e cartao pelo link em evolucao</li><li>Implantacao assistida para colocar a primeira arena no ar</li></ul></main></div></div>`;
