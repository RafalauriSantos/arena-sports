...
const CRITICAL_HTML = `<div id="root"><div data-seo-ready class="min-h-screen bg-[#02040a] text-white font-sans"><main class="relative z-10"><h1 class="text-4xl md:text-5xl font-bold tracking-tight text-white mt-8">ArenaSys - Sistema de Gestão e Agendamento de Quadras Esportivas</h1><p class="text-lg md:text-xl text-gray-300 mt-4 max-w-2xl">Sistema completo de gestão e agendamento para quadras esportivas. Automatize reservas, receba pagamentos via PIX, gerencie horários e clientes. Teste grátis por 7 dias. A partir de R$ 97/mês.</p><p class="text-gray-400 mt-6">Software para arenas, quadras society e agendamento online. Gestão de reservas esportivas, booking e SaaS para quadras.</p></main></div></div>`;
