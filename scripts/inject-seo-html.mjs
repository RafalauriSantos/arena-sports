...
const CRITICAL_HTML = `<div id="root"><div data-seo-ready class="min-h-screen bg-[#eef4fb] text-slate-950 font-sans"><main class="relative z-10"><h1 class="text-4xl md:text-5xl font-bold tracking-tight text-slate-950 mt-8">Sistema de Gestão e Agendamento de Quadras Esportivas | ArenaSys</h1><p class="text-lg md:text-xl text-slate-600 mt-4 max-w-2xl">Evite conflitos de horários, receba reservas pelo link e organize sua arena em um só lugar. Software completo para quadras de futebol, society, vôlei, tênis e beach tennis.</p><p class="text-slate-500 mt-4">Gestão profissional de quadras esportivas. Link público para seus clientes agendarem online. Dashboard administrativo completo. A partir de R$ 97/mês. Teste grátis por 7 dias sem cartão de crédito.</p><ul class="text-slate-600 mt-4 space-y-2"><li>Agendamento online 24/7 para seus clientes</li><li>Link público de reserva</li><li>Controle de mensalistas e horários fixos</li><li>Notificações por WhatsApp</li><li>Relatórios de faturamento e ocupação</li></ul></main></div></div>`;
